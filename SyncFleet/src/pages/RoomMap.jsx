...
// import { IoLocationSharp, IoExitOutline, IoAlertCircle, IoMdSend } from "react-icons/io5";
...
// import StationaryPrompt from "./components/StationaryPrompt";
...
// // Import utilities
// import { createPulsingIcon, createGroupCenterIcon } from "./components/MapMarkers";
// import { geocodeLocation } from "../utils/geocoding";
// import { isOutsideGeofence, calculateDeviation, calculateGroupCenter } from "../utils/locationUtils";
// import { apiCallToGetRoom, sendBatteryStatus, emitLocationUpdate } from "../utils/roomUtils";
// import {
//   STATIONARY_LIMIT,
//   MOVEMENT_THRESHOLD,
//   INACTIVE_THRESHOLD,
...
//                   attribution='&copy; <a hreps://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
//                 />
...
// const LoadingOrError = ({ isUserReady, user, locationError }) => {
//   if (!isUserReady) {
//     return (
//       <div className="flex items-center justify-center h-screen">
//         <p className="text-gray-500 text-lg">Loading user data...</p>
